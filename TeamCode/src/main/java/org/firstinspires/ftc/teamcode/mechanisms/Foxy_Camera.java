...
import org.firstinspires.ftc.teamcode.FOXY_CONFIG;
import org.firstinspires.ftc.teamcode.Foxy_Robot;
...
public class Foxy_Camera {
    ...
    public void init(CameraName cameraName, HardwareMap hwMap, Telemetry telemetry) {
        ...
        aprilTagProcessor = new AprilTagProcessor.Builder()
                .setDrawTagID(FOXY_CONFIG.MODE_DEBUG)
                .setDrawTagOutline(FOXY_CONFIG.MODE_DEBUG)
                .setDrawAxes(FOXY_CONFIG.MODE_DEBUG)
                .setDrawCubeProjection(FOXY_CONFIG.MODE_DEBUG)
                .setOutputUnits(DistanceUnit.INCH, AngleUnit.DEGREES)
                .setSuppressCalibrationWarnings(false)
                .setLensIntrinsics(FOXY_CONFIG.HW_SENSORS_CAMERA_FX,
                                FOXY_CONFIG.HW_SENSORS_CAMERA_FY,
                                FOXY_CONFIG.HW_SENSORS_CAMERA_CX,
                                FOXY_CONFIG.HW_SENSORS_CAMERA_CY)
                .build();
