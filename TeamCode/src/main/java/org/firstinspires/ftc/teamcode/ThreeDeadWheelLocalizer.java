...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3262.2480647078487; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2987.524892804051; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3269.202400712893; // x position of the perpendicular encoder (in tick units)
    }
